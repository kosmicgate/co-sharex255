...
export function BottomNav({ step, onPrev, onNext }: { step: number; onPrev: () => void; onNext: () => void }) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 36 }}>
      ...
      <div
        onClick={onNext}
        style={{
          cursor: 'pointer', border: `1.5px solid ${colors.ink}`, borderRadius: 6, padding: '12px 26px',
